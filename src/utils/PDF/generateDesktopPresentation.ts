  ...
  <head>
    ...
    <style>
      ...
      * {
      ...
      .btn-back { display: inline-flex; align-items: center; gap: 6px; background: rgba(255, 255, 255, 0.14); color: #ffffff; border: 1px solid rgba(255, 255, 255, 0.28); padding: 8px 18px; border-radius: 9999px; font-size: 15px; font-weight: 700; cursor: pointer; }
