...
const PINTEREST_HEIGHTS = ['h-[130px]', 'h-[210px]', 'h-[160px]', 'h-[240px]', 'h-[180px]', 'h-[140px]'];
...
export const GallerySkeleton = memo(function GallerySkeleton({ 
  ...
  return (
    <div 
      className={`${containerLayoutClass} transition-opacity duration-500 ease-out`}
    ...
    >
      {mockItems.map((_, index) => {
        ...
        if (cols === '1') {
          ...
          itemClass = `break-inside-avoid inline-block w-full mb-3 min-h-[100px] ${PINTEREST_HEIGHTS[index % PINTEREST_HEIGHTS.length]}`;
        }
        ...
        return (
          <div 
            ...
            className={`
              ...
              bg-zinc-200/90 dark:bg-zinc-800/80 
              animate-pulse 
