...
const HeaderText = memo(function HeaderText({
  ...
  style={{
    fontSize: isReadOnly ? undefined : "16px",
    WebkitTextSizeAdjust: "100%",
  }}
  className={`${isReadOnly ? readOnlyInput : editableInput} ${
    alignCenter ? "text-center" : ""
  } text-blue-500 dark:text-blue-400 font-black ${
    isReadOnly ? "text-[11px] md:text-xs" : "text-[16px]"
  } uppercase tracking-[0.16em] truncate max-w-full`}
/>
...
<textarea
  ...
  rows={1}
  style={{
    fontSize: isReadOnly ? titleFontSize : mobileSafeFont(titleFontSize),
    WebkitTextSizeAdjust: "100%",
  }}
  className={`${isReadOnly ? readOnlyInput : editableInput} ${
    alignCenter ? "text-center" : ""
...
<textarea
  ...
  rows={2}
  style={{
    fontSize: isReadOnly ? descFontSize : mobileSafeFont(descFontSize),
    WebkitTextSizeAdjust: "100%",
  }}
  className={`${isReadOnly ? readOnlyInput : editableInput} ${
