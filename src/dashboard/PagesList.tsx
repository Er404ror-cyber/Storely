...
const notify = {
  success: (msg: string) => toast.success(msg, {
    id: 'admin-success', // Evita spam de toasts iguais
    style: {
      border: '1px solid #6366f1',
      padding: '16px',
      color: '#fff',
      background: 'rgba(15, 23, 42, 0.95)', // Slate-900 com opacidade alta
  ...
  error: (msg: string) => toast.error(msg, {
    ...
    style: {
      ...
      padding: '16px',
      color: '#fff',
      background: 'rgba(127, 29, 29, 0.95)', // Vermelho escuro profundo
      backdropFilter: 'blur(10px)',
      borderRadius: '24px',
      fontWeight: '900',
      fontSize: '13px',
