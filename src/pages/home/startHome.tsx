    ...
    <meta name="description" content={t('hero_desc')} />
                    ...
                    <div className="flex flex-col lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                        <div className="relative z-10 order-1">
                            ...
                            <h1 className="text-[2.75rem] leading-[0.9] sm:text-7xl lg:text-8xl font-black tracking-tighter mb-6 text-zinc-900 dark:text-white">
                                {t('hero_title_1')} <br />
                                <span className="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">{t('hero_title_2')}</span> {t('hero_title_3')} <br />
                                <span className="text-zinc-400 dark:text-zinc-400 italic font-serif">{t('hero_title_4')}</span>
                            </h1>
                        ...
                        <div className="relative order-2 w-full mt-4 lg:mt-0 group">
                            <div className="relative rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-1.5 shadow-xl sm:p-2">
                                ...
                                <div className="aspect-[4/3] rounded-xl overflow-hidden bg-zinc-100 dark:bg-zinc-800">
                                    <img src="https://www.nitrahost.com/images/website-builder.png" alt="Platform Preview" className="w-full h-full object-cover" loading="eager" />
                                </div>
                            </div>
                            <div className="absolute -bottom-4 -left-4 bg-white dark:bg-zinc-900 px-4 py-3 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-lg hidden sm:flex items-center gap-3">
                                <div className="w-8 h-8 rounded-full bg-emerald-500 flex items-center justify-center text-white font-bold text-[10px]">100</div>
            ...
            <section className="py-24 bg-zinc-50 dark:bg-zinc-900/30 border-y border-zinc-200 dark:border-zinc-800 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16">
                        <p className="text-blue-600 dark:text-blue-400 font-bold tracking-[0.2em] uppercase text-xs mb-2">{t('feat_tag')}</p>
                        <h2 className="text-3xl md:text-5xl font-black tracking-tighter">{t('feat_title')}</h2>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
                        <div className="max-w-xl">
                            <h2 className="text-4xl md:text-6xl font-black tracking-tighter leading-[1.1] mb-8">
                                {t('showcase_title_1')} <br /> 
                                <span className="text-zinc-400 dark:text-zinc-600 italic font-serif">{t('showcase_title_2')}</span>
                            </h2>
                            <p className="text-zinc-500 dark:text-zinc-400 mt-4 text-lg font-medium">{t('showcase_desc')}</p>
                        </div>
                        <div className="h-px flex-1 bg-zinc-200 dark:bg-zinc-800 hidden lg:block mx-12 mb-6" />
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                        <ProjectCard category={t('proj_1_tag')} title="Vercel Commerce" url="https://demo.vercel.store" description={t('proj_1_desc')} />
                        <ProjectCard category={t('proj_2_tag')} title="Tailwind Components" url="https://storelyy.vercel.app/tio/" description={t('proj_2_desc')} />
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto relative">
                    <div className="relative p-8 md:p-20 rounded-[3.5rem] overflow-hidden border border-zinc-200 dark:border-white/10 bg-white/50 dark:bg-zinc-900/50 shadow-2xl shadow-blue-500/10">
                        <div className="relative z-10 flex flex-col items-center text-center">
                            ...
                            <h2 className="text-4xl md:text-7xl font-black tracking-tighter leading-[0.95] mb-8 text-zinc-900 dark:text-white">
                                {t('cta_title_1')} <br />
                                <span className="italic font-serif text-blue-600 dark:text-blue-500">{t('cta_title_2')}</span> {t('cta_title_3')}
                            </h2>
                            <p className="max-w-md text-zinc-500 dark:text-zinc-400 text-lg mb-12 leading-relaxed">
                                {t('cta_desc')}
                                <span className="font-bold text-zinc-900 dark:text-zinc-100"> {t('cta_subtitle')}</span>
                            </p>
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
                                ...
                                <div className="flex -space-x-3 items-center ml-2">
                                    {[1, 2, 3].map((i) => <div key={i} className="w-10 h-10 rounded-full border-2 border-white dark:border-zinc-900 bg-zinc-300" />)}
                                    <p className="ml-6 text-sm font-bold text-zinc-400">{t('cta_members')}</p>
                                </div>
                            </div>
                        </div>
                    </div>
